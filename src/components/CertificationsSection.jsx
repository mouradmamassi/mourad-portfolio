...
const certifications = [
  {
    ...
    issuer: "VMware",
    date: "Date de délivrance : avr. 2024",
  ...
  },
  {
    ...
    date: "Émise le avr. 2023 · Expire le avr. 2026",
  ...
  },
  {
    ...
    date: "Émise le juin 2023 · Expire le juin 2025",
    logo: "/images/devops_institute_logo.jpeg",
    altText: "Logo DEVOPS INSTITUTE",
    id: "24412975" // Ajout de l'identifiant, sans URL
  }
];
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-12">Mes certifications</h2>
